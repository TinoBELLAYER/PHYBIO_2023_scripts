# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 14:16:33 2023
...
figname = data_thermo.filename[:-4] + "_Temperature.png"
data_thermo._fig2D(data_thermo.time [4801:9906], data_thermo.temp[4801:9906], 
                    "Temperature (degree C)", figname, "%H:%M:%S ")
#data_thermo._savepickle()
# READ .THS FILE

data_thermo2._loadnc()  # Temp. in m
figname2 = data_thermo2.filename[:-4] + "_Temperature.png"
data_thermo2._fig2D(data_thermo2.time [4801:11409], data_thermo2.temp[4801:11409], 
                    "Temperature (degree C)", figname2, "%H:%M:%S ")

data_thermo3._loadnc()
figname3 = data_thermo3.filename[:-4] + "_Temperature.png"
data_thermo3._fig2D(data_thermo3.time [6725:] , data_thermo3.temp[6725:], 
                    "Temperature (degree C)", figname3, "%H:%M:%S ")